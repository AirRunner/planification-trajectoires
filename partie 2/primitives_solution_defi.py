...
class PickBall(Action):
    ...
    def execute(self):
        ...
        if isPlanValid(plan):
            ...
            self.moveGroup.set_joint_value_target(targetVals)

            planMonter = self.moveGroup.plan()


            if isPlanValid(planMonter):


                self.moveGroup.execute(planMonter)
                print("== RaiseBall completed")
            else:
                print("== RaiseBall FAILED")
...
class DropBall(Action):
    ...
    def execute(self):
        ...
        if isPlanValid(planDescendre):
            ...
            print("== LowerBall completed")
        else:
            print("== LowerBall FAILED")
        ...
        moveGroup.detach_object(name= 'r_gripper_r_finger_link')
